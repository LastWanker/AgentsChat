...
"""LLM 群聊 demo：需要环境变�?LLM_ENABLED=1 �?LLM_API_KEY（或 config_data/llm.env）�?""
from pathlib import Path

from agents_chat.domain import Agent
from agents_chat.infrastructure.config import load_settings
from agents_chat.infrastructure.llm import build_openai_client_from_settings
...
def main():
    ...
    if not settings.llm_api_key:
        print("[test4llm_chat_demo] ⚠️ 未提�?LLM_API_KEY，无法演示�?)
        return
